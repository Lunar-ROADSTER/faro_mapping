...
def generate_costmap(points, plane_model, resolution, map_size, threshold_above):
    ...
    for point in points:
        ...
        if threshold_above < height < 0.025:
...
if __name__ == "__main__":
    ...
    costmap = generate_costmap(points, plane_model, resolution, map_size, obstacle_threshold_above)
