...
obstacle_threshold_below_min = -0.036
obstacle_threshold_below_max = -0.0399
map_size = (750, 700)
...
def generate_costmap(points, plane_model, resolution, map_size, threshold_below_min, threshold_below_max):
    ...
    for point in points:
        ...
        if height < threshold_below_min and height < threshold_below_max:
...
if __name__ == "__main__":
    ...
    costmap = generate_costmap(points, plane_model, resolution, map_size, obstacle_threshold_below_min, obstacle_threshold_below_max)
